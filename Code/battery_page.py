...
class BatteryPage(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        self.title_label = ttk.Label(self, text="Backup System", font=self.title_font)
        self.title_label.grid(row=1, column=0, columnspan=1, pady=10, sticky='w')
        
        self.title_label = ttk.Label(self, text="Battery bank", font=self.subtitle_font)
        ...
        self.nav_frame = NavigationFrame(self, back_command=controller.show_previous_page_from_battery, next_command=controller.show_GeneratorPage)
    
        # next_button = ttk.Button(self, text="Next", command=controller.show_GeneratorPage)
        # next_button.grid(row=30, column=3, sticky='w')
        
        # back_button = ttk.Button(self, text="Back", command=controller.show_previous_page_from_battery)
