...
class Constraints_Greenfield_Milp():
    ...
    def Battery_Replacement_Cost_NonAct(model,s):
        ...
        if model.Battery_Degradation == 1 and model.Battery_Iterative_Replacement == 0:
            return model.Battery_Replacement_Cost_NonAct[s] == 0 
    ...
    def RES_inst(model,yt,ut,r,g):
        return model.RES_Units_milp[ut,r] >= model.Generator_Units[ut,g]
    ...
    def Battery_Bank_Degradation(model,s,yt,ut,t):
        ...
        if t == 1 and yt != 1:
            if  model.Battery_Iterative_Replacement == 1 and yt == model.Battery_Replacement_Year:
