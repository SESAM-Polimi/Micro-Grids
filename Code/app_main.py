...
class Application(ThemedTk):
    def __init__(self):
        ...
        self.title("MicroGridsPy Data Input")  # Set the application title
        self.geometry("800x700")      # Set the default size of the application
    ...
    def write_to_dat_file(self, data):
     ...
     with open('Inputs/Parameters.dat', 'w') as file:
