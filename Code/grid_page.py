...
class GridPage(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        self.title_label = ttk.Label(self, text="On-Grid Model", font=self.title_font)
        self.title_label.grid(row=1, column=0, columnspan=1, pady=10, sticky='w')
        
        self.title_label = ttk.Label(self, text="Grid Connection", font=self.subtitle_font)
        ...
        next_button = ttk.Button(self, text="Next", command=lambda: controller.show_frame("PlotPage"))
        next_button.grid(row=30, column=3, sticky='w')
        
        back_button = ttk.Button(self, text="Back", command=controller.show_previous_page_from_grid)
