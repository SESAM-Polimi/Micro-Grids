...
#-----------------------------------------------------------------------------   
    ...
    # MILP Formulation
    model.Compressor_Nominal_Capacity_milp      = Param(within=NonNegativeIntegers)
    ...
    model.Ice_Tank_Depth_of_Discharge       = Param(within=NonNegativeReals)                                # Depth of discharge of the Ice_Tank in %
    ...
    model.Ice_Tank_Independence             = Param(within=NonNegativeReals)
...
#############
    ...
    model.Tot_Ice_Prod                        = Var(model.scenarios,
                                                    ...
                                                    model.periods,
                                                    within=NonNegativeReals)
    "Variables associated to the Ice Production"
    model.Compressor_Energy_Consumption       = Var(model.scenarios,
                                                    model.years,
                                                    model.periods,
                                                    within=NonNegativeReals)
    model.Compressor_Nominal_Capacity         = Var(model.steps,
                                                    within=NonNegativeReals)
    # MILP Formulation
    model.Compressor_Units                    = Var(model.steps,
                                                    within=NonNegativeIntegers)
