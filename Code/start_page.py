...
class StartPage(tk.Frame):
    ...
    def on_next_button(self):
        ...
        if milp_formulation == 1 and partial_load == 1:
           generator_page.display_extra_parameter()
        if milp_formulation == 1 and partial_load == 0:
           generator_page.display_extra_parameter_milp()
    ...
    def __init__(self, parent, controller):
        ...
        self.title_label = ttk.Label(self, text="MicroGridsPy - Data Input", font=self.title_font,style='TLabel')
        self.title_label.grid(row=0, column=0, columnspan=1, pady=10)  # Increase columnspan for alignment

        # Section title: Model Configuration
        self.title_label = ttk.Label(self, text="Model Configuration", font=self.subtitle_font,style='TLabel')
        ...
        ttk.Label(self, text="Total Project Duration [Years]:", anchor='w',style='TLabel').grid(row=2, column=0, sticky='w')
        self.Years_var = tk.IntVar(value=20)
        vcmd = (self.register(self.validate_integer), '%P')
        self.Years_entry = ttk.Entry(self, textvariable=self.Years_var, validate='key', validatecommand=vcmd)
        self.Years_entry.grid(row=2, column=1, sticky='w')
        create_tooltip(self.Years_entry, "Enter the duration of the project in years")

        # Step Duration
        ttk.Label(self, text="Step Duration [Years]:", anchor='w').grid(row=3, column=0, sticky='w')
        self.Step_Duration_var = tk.IntVar(value=1)
        vcmd = (self.register(self.validate_integer), '%P')
        self.Step_Duration_entry = ttk.Entry(self, textvariable=self.Step_Duration_var,validate='key', validatecommand=vcmd)
        ...
        ttk.Label(self, text="Minimum Last Step Duration [Years]:", anchor='w').grid(row=4, column=0, sticky='w')
        self.Min_Step_Duration_var = tk.IntVar(value=1)
        vcmd = (self.register(self.validate_integer), '%P')
        self.Min_Step_Duration_entry = ttk.Entry(self, textvariable=self.Min_Step_Duration_var,validate='key', validatecommand=vcmd)
        ...
        # Real_Discount_Rate
        ttk.Label(self, text="Discount Rate [-]:", anchor='w').grid(row=5, column=0, sticky='w')
        self.Real_Discount_Rate_var = tk.DoubleVar(value=0.1)
        vcmd = (self.register(self.validate_float), '%P')
        self.Real_Discount_Rate_entry = ttk.Entry(self, textvariable=self.Real_Discount_Rate_var,validate='key', validatecommand=vcmd)
        ...
        # Start Date Entry
        ttk.Label(self, text="Start Date of the Project:",anchor='w').grid(row=6, column=0, sticky='w')
        ...
        self.title_label = ttk.Label(self, text="Optimization setup", font=self.subtitle_font)
        self.title_label.grid(row=1, column=2, columnspan=1, pady=10, sticky='w', padx=(30, 0))  # Align to west (left), start from column 2

        # Renewable Penetration
        ttk.Label(self, text="Renewable Penetration [-]", anchor='w').grid(row=2, column=2, sticky='w',padx=(30, 0))
        self.Renewable_Penetration_var = tk.DoubleVar(value=0.0)
        vcmd = (self.register(self.validate_fraction), '%P')
        self.Renewable_Penetration_entry = ttk.Entry(self, textvariable=self.Renewable_Penetration_var,validate='key', validatecommand=vcmd)
        ...
        ttk.Label(self, text="Battery Independence [Days]", anchor='w').grid(row=3, column=2, sticky='w',padx=(30, 0))
        self.Battery_Independence_var = tk.StringVar(value="0")
        vcmd = (self.register(self.validate_integer), '%P')
        self.Battery_Independence_entry = ttk.Entry(self, textvariable=self.Battery_Independence_var,validate='key', validatecommand=vcmd)
        ...
        # Lost Load Fraction
        ttk.Label(self, text="Lost Load Fraction [-]", anchor='w').grid(row=4, column=2, sticky='w',padx=(30, 0))
        self.Lost_Load_Fraction_var = tk.DoubleVar(value=0.0)
        vcmd = (self.register(self.validate_float), '%P')
        self.Lost_Load_Fraction_entry = ttk.Entry(self, textvariable=self.Lost_Load_Fraction_var,validate='key', validatecommand=vcmd)
        ...
        vcmd = (self.register(self.validate_float), '%P')
        self.Lost_Load_Specific_Cost_label = ttk.Label(self, text="Lost Load Specific Cost [USD/Wh]", anchor='w')
        self.Lost_Load_Specific_Cost_label.grid(row=5, column=2, sticky='w',padx=(30, 0))
        self.Lost_Load_Specific_Cost_entry = ttk.Entry(self, textvariable=self.Lost_Load_Specific_Cost_var,validate='key', validatecommand=vcmd)
        ...
        ttk.Label(self, text="Investment Cost Limit [USD]",anchor='w').grid(row=6, column=2,sticky='w',padx=(30, 0))
        self.Investment_Cost_Limit_var = tk.DoubleVar(value="500000")
        vcmd = (self.register(self.validate_float), '%P')
        self.Investment_Cost_Limit_entry = ttk.Entry(self, textvariable=self.Investment_Cost_Limit_var,validate='key', validatecommand=vcmd)
        ...
        ttk.Label(self, text="Optimization Goal:",anchor='w').grid(row=8, column=0,sticky='w',ipady=20)
        self.Optimization_Goal_radio1 = ttk.Radiobutton(self, text="NPC", variable=self.Optimization_Goal_var, value=1)
        self.Optimization_Goal_radio1.grid(row=8, column=1, sticky='w')
        self.Optimization_Goal_radio0 = ttk.Radiobutton(self, text="Operation cost", variable=self.Optimization_Goal_var, value=0)
        ...
        ttk.Label(self, text="Backup Systems:", anchor='w').grid(row=9, column=0, sticky='w')
        self.Model_Components_radio0 = ttk.Radiobutton(self, text="Batteries and Generators", variable=self.Model_Components_var, value=0)
        self.Model_Components_radio0.grid(row=9, column=1, sticky='w')
        self.Model_Components_radio1 = ttk.Radiobutton(self, text="Batteries Only", variable=self.Model_Components_var, value=1)
        self.Model_Components_radio1.grid(row=10, column=1, sticky='w')
        self.Model_Components_radio2 = ttk.Radiobutton(self, text="Generators Only", variable=self.Model_Components_var, value=2)
        ...
        self.title_label = ttk.Label(self, text="Advanced Features", font=self.subtitle_font)
        self.title_label.grid(row=12, column=0, columnspan=1, pady=10, sticky='w')


        # MILP Formulation
        self.MILP_Formulation_var = tk.IntVar(value=0)
        ttk.Label(self, text="Model Formulation:", anchor='w').grid(row=13, column=0, sticky='w')
        self.MILP_Formulation_radio0 = ttk.Radiobutton(self, text="LP", variable=self.MILP_Formulation_var, value=0)
        self.MILP_Formulation_radio0.grid(row=13, column=1, sticky='w')
        self.MILP_Formulation_radio1 = ttk.Radiobutton(self, text="MILP", variable=self.MILP_Formulation_var, value=1)
        ...
        self.Generator_Partial_Load_label = ttk.Label(self, text="Generator Partial Load:", anchor='w')
        self.Generator_Partial_Load_label.grid(row=14, column=0, sticky='w')
        self.Generator_Partial_Load_checkbutton = ttk.Checkbutton(self, text="Activate", variable=self.Generator_Partial_Load_var, onvalue=1, offvalue=0)
        ...
        ttk.Label(self, text="Multi-Objective Optimization:", anchor='w').grid(row=15, column=0, sticky='w')
        self.Multiobjective_Optimization_checkbutton = ttk.Checkbutton(self, text="Activate", variable=self.Multiobjective_Optimization_var, onvalue=1, offvalue=0)
        ...
        self.Plot_Max_Cost_label = ttk.Label(self, text="Plot Max Cost:", anchor='w')
        self.Plot_Max_Cost_label.grid(row=16, column=0, sticky='w')
        self.Plot_Max_Cost_radio1 = ttk.Radiobutton(self, text="Yes", variable=self.Plot_Max_Cost_var, value=1, state='disabled')
        ...
        self.Plot_Max_Cost_radio0 = ttk.Radiobutton(self, text="No", variable=self.Plot_Max_Cost_var, value=0, state='disabled')
        ...
        ttk.Label(self, text="Type of Investment:",anchor='w').grid(row=17, column=0,sticky='w')
        ttk.Radiobutton(self, text="Greenfield", variable=self.Greenfield_Investment_var, value=1).grid(row=17, column=1, sticky='w')
        ttk.Radiobutton(self, text="Brownfield", variable=self.Greenfield_Investment_var, value=0).grid(row=17, column=1, sticky='e')
        ...
        ttk.Label(self, text="Grid Connection:", anchor='w').grid(row=18, column=0, sticky='w')
        self.Grid_Connection_radio = ttk.Radiobutton(self, text="On-grid", variable=self.Grid_Connection_var, value=1)
        ...
        self.Grid_Availability_Simulation_label = ttk.Label(self, text="Grid Availability:", anchor='w')
        self.Grid_Availability_Simulation_label.grid(row=19, column=0, sticky='w')
        self.Grid_Availability_Simulation_label.config(state='disabled')
        self.Grid_Availability_Simulation_checkbutton = ttk.Checkbutton(self, text="Activate", variable=self.Grid_Availability_Simulation_var, onvalue=1, offvalue=0)
        ...
        self.Grid_Connection_Type_label = ttk.Label(self, text="Grid Connection Type:", anchor='w', state='disabled')
        self.Grid_Connection_Type_label.grid(row=20, column=0, sticky='w')
        self.Grid_Connection_Type_radio1 = ttk.Radiobutton(self, text="Purchase", variable=self.Grid_Connection_Type_var, value=1, state='disabled')
        self.Grid_Connection_Type_radio1.grid(row=20, column=1, sticky='w')
        self.Grid_Connection_Type_radio2 = ttk.Radiobutton(self, text="Sell/Purchase", variable=self.Grid_Connection_Type_var, value=2, state='disabled')
        ...
        self.WACC_Calculation_label = ttk.Label(self, text="WACC Calculation:", anchor='w')
        self.WACC_Calculation_label.grid(row=13, column=2, sticky='w',padx=(30, 0))
        self.WACC_Calculation_checkbutton = ttk.Checkbutton(self, text="Activate", variable=self.WACC_Calculation_var, onvalue=1, offvalue=0, command=self.toggle_wacc_parameters)
        ...
        for i, (param, value) in enumerate(wacc_parameters.items(), start=14):  # Adjust the starting row accordingly
            ...
            entry = ttk.Entry(self, textvariable=var, state='normal', validate='key', validatecommand=vcmd)  # Initially set state to 'normal' to show the value
            entry.var = var
        ...
        # go_to_re_calc_button = ttk.Button(self, text="Next", command=self.on_next_button)
